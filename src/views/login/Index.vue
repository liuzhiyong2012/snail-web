	...
	<div class="login">
		...
		<div class="form">
			<div class="user-details">
				<div class="i-icon">
					<svg class="icon" aria-hidden="true"><use xlink:href="#icon-phone1" /></svg>
				</div>
				<input v-model="userPhone" class="form-input padding1" maxlength="20" :placeholder="$t('placeholderPhone')" type="number" />
				<div class="area-code" @click="clickShowAreaCode">+ {{ areaCode }}</div>
				<div class="area-code-line"></div>
				<van-popup v-model="showAreaCode" position="bottom" :style="{ height: '36%' }">
					<van-picker
						show-toolbar
						:columns="columns"
			...
			<div class="user-details m40">
				<div class="i-icon">
					<svg class="icon" aria-hidden="true"><use xlink:href="#icon-code1" /></svg>
				</div>
				<input v-model="userPassword" class="form-input" :placeholder="$t('placeholderPassword')" type="password" />
			</div>
		</div>
		...
		<div class="line"><div class="other"></div></div>
