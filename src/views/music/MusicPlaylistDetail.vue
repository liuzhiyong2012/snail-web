<template>
	<section class="music-main-ctn">
		...
		<section class="cover-ctn">
			<div class="cover-title" @click="goBack()"><i class="icon icon-back"></i></div>
			...
			<div class="cover-content">
				...
				<div class="cover-info">
					...
					<div class="collect-ctn disable" v-if="isCollected" @click="unSubscribePlaylist()">
						<svg class="icon" aria-hidden="true"><use xlink:href="#icon-collect-cancle"></use></svg>
		...
		<section class="content-ctn">
			...
			<div class="collect-list-ctn">
				<div v-for="(item, index) in playListObj.Tracks" :key="index" class="mysong-item" @click="playSong(index)">
			...
			if (res.code == '200') {
				...
				this.playListObj.Tracks.forEach((item, index) => {
					songs.push({
						...
						id: item.Id,
						image: UrlUtils.addBaseUrl(UrlUtils.delBaseUrl(this.playListObj.CoverImgUrl)),
						mid: '',
						name: item.Name,
