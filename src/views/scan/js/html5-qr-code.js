...
function _classCallCheck_new(a, b) {
...
var Html5Qrcode = function() {
	function a(b, c) {
		if (_classCallCheck_new(this, a), !getLazarSoftScanner) throw "Use html5qrcode.min.js without edit, getLazarSoftScannernot found.";
...
//				d._possiblyCloseLastScanImageFile(), d._clearElement(), d._lastScanImageFile = b;
				...
				h.onload = function() {
					var b = Math.max,
						i = h.width,
						j = h.height,
						k = fileEle||document.getElementById(d._elementId),
